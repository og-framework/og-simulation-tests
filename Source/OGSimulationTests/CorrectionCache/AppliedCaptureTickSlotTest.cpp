...
namespace
{
	...
	// allocateFrontierSlotsAll` (item 94, was resolution's sweep 2 through
	// item 93) + postPredictionAll produce it.
	//
	...
	// call in the frontier-allocating sweep this helper mirrors. Nothing below asserted on it:
